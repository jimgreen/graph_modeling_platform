...
This project is indexed by GitNexus as **graph_modeling_platform** (3139 symbols, 10609 relationships, 269 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
