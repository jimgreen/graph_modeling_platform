...
This project is indexed by GitNexus as **graph_modeling_platform** (3141 symbols, 10606 relationships, 269 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
