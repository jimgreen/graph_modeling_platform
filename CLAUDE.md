...
This project is indexed by GitNexus as **graph_modeling_platform** (2443 symbols, 8214 relationships, 213 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
