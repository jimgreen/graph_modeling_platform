...
This project is indexed by GitNexus as **graph_modeling_platform** (4693 symbols, 17448 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
