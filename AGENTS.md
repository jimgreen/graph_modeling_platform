...
This project is indexed by GitNexus as **graph_modeling_platform** (4708 symbols, 17452 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
