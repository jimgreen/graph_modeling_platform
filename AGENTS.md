...
This project is indexed by GitNexus as **graph_modeling_platform** (3165 symbols, 10727 relationships, 271 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
