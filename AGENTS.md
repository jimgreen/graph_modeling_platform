...
This project is indexed by GitNexus as **graph_modeling_platform** (9559 symbols, 24484 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
