...
This project is indexed by GitNexus as **graph_modeling_platform** (475 symbols, 1273 relationships, 39 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
