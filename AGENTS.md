...
This project is indexed by GitNexus as **graph_modeling_platform** (3161 symbols, 10709 relationships, 270 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
