...
This project is indexed by GitNexus as **graph_modeling_platform** (10203 symbols, 26523 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
