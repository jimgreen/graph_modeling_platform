...
This project is indexed by GitNexus as **graph_modeling_platform** (3134 symbols, 10582 relationships, 268 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
