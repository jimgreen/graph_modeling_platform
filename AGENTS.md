...
This project is indexed by GitNexus as **graph_modeling_platform** (5563 symbols, 20819 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
