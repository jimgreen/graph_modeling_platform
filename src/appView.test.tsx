...
describe("app view device definition parameter rows", () => {
  ...
  test("keeps the top toolbar compact with icon-only mode and export actions", () => {
    ...
    expect(exportActions).toContain('exportSvg("gbk")');
    expect(exportActions).toContain('exportSvg("utf-8")');
    expect(exportActions).toContain('exportEFile("gbk")');
    expect(exportActions).toContain('exportEFile("utf-8")');
    expect(exportActions).toContain("modelTypeMismatchMessage()");
    expect(exportActions).toContain('exportSvgFile("gbk")');
    expect(exportActions).toContain('exportSvgFile("utf-8")');
    expect(exportActions).toContain('exportJsonFile("gbk")');
    expect(exportActions).toContain('exportJsonFile("utf-8")');
    ...
    expect(exportActions).toContain('className="export-submenu"');
    expect(exportActions).toContain('className="export-encoding-menu"');
    expect(exportActions).toContain('aria-label="导出 E 文件字符编码"');
    expect(exportActions).toContain("GBK");
    expect(exportActions).toContain("UTF-8");
    expect(exportActions).not.toContain("requestExportWithSave(exportSvg)");
