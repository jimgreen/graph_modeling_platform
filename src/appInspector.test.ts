...
describe("graph inspector panel", () => {
  ...
  test("exposes dynamic measurement configuration and per-device measurement operations", async () => {
    ...
    const devicePanelEnd = source.indexOf("{inspectorSelectedNode && inspectorTab === \"graph\" && graphInfoView === \"selected\" && (", devicePanelStart);
    ...
    expect(measurementConfigDialogBlock).toContain("measurement-profile-table");
    expect(measurementConfigDialogBlock).toContain("量测名称");
    expect(measurementConfigDialogBlock).toContain("量测位置");
    expect(measurementConfigDialogBlock).toContain("设备层");
    expect(measurementConfigDialogBlock).toContain("端子层");
    expect(measurementConfigDialogBlock).toContain("添加量测");
    expect(measurementConfigDialogBlock).toContain("上移");
    expect(measurementConfigDialogBlock).toContain("下移");
    ...
    expect(devicePanelBlock).toContain('aria-label="设备表格内容切换"');
    ...
    expect(selectedMeasurementTableBlock).toContain("selectedMeasurementGroups.map");
