...
describe("graph inspector panel", () => {
  ...
  test("places device measurement bindings inside the component definition dialog", async () => {
    ...
    const customTabsEnd = dialogBlock.indexOf('{customDeviceDialogView === "terminals" || customDeviceDialogView === "icon"', customTabsStart);
    const customTabsBlock = dialogBlock.slice(customTabsStart, customTabsEnd);
    const customVisualStart = dialogBlock.indexOf('{customDeviceDialogView === "terminals" || customDeviceDialogView === "icon"');
    ...
    expect(customVisualBlock).toContain('customDeviceDialogView === "terminals"');
    expect(customVisualBlock).toContain('customDeviceDialogView === "icon"');
    expect(customVisualBlock).toContain('customDeviceDialogView === "terminals" && <div className="custom-terminal-grid"');
    expect(customVisualBlock).toContain('customDeviceDialogView === "icon" && customDefaultStateSelected && <div className="custom-device-image-row"');
    expect(dialogBlock).toContain('customDeviceDialogView === "parameters"');
    expect(dialogBlock).toContain('customDeviceDialogView === "measurements"');
    ...
    expect(source).toContain("const renderDeviceDefinitionMeasurementPanel = (target: DeviceDefinitionMeasurementPanelTarget)");
