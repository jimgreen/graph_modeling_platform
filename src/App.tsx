...
import type { SymbolExportScheme } from "./symbolExportSvg";
...
// 【导出图元 Symbol】弹窗：树/勾选/搜索是弹窗内部状态，这里只放「开关 + 方案快照 + 提示」，
// 方案快照由 appSymbolExportFactories 的后端读写工厂维护。
const [symbolExportDialogOpen, setSymbolExportDialogOpen] = useState(false);
const [symbolExportSchemes, setSymbolExportSchemes] = useState<SymbolExportScheme[]>([]);
const [symbolExportSchemesStatus, setSymbolExportSchemesStatus] = useState("");
Object.assign(__appScope, {
  symbolExportDialogOpen, setSymbolExportDialogOpen,
  symbolExportSchemes, setSymbolExportSchemes,
  symbolExportSchemesStatus, setSymbolExportSchemesStatus
});
