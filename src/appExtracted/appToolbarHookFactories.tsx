    ...
    return (
      <g
        ...
        onDoubleClick={(event) => {
          ...
          event.stopPropagation();
          openMeasurementEditorForNode(node);
        }}
      >
