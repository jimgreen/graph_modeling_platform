...
export async function fetchBackendDeviceLibrary(): Promise<DeviceLibraryPersistencePayload & {
  ...
  const comparablePayload = normalizeDeviceLibraryPersistencePayload({
    ...payload,
...
export const DEVICE_LIBRARY_SCHEMA_VERSION = 3;
