...
export function useAppStateBatch(__appScope: Record<string, any>) {
  ...
  const componentLibraryMeasurementProfiles = useMemo(
      ...
      [customComponentLibraries, deviceDefinitionOverrides, libraryTemplates]
    );
  Object.assign(__appScope, { componentLibraryMeasurementProfiles });
  const runtimeMeasurementConfig = useMemo(
      () => mergeComponentLibraryMeasurementProfiles(measurementConfig, componentLibraryMeasurementProfiles),
  ...
  const displayedCategoryLibraries = useMemo(
      () => librarySearchNeedle
        ? categoryLibraries.filter((group) => rootComponentLibraryGroupsForDisplay(
            group,
        ...
        : categoryLibraries,
      [categoryLibraries, customComponentLibraries, groupedCategoryLibraryByComponentLibrary, librarySearchNeedle]
    );
